          ...
          <div className="row">
            <div className="col-12">
              <div className="row border-bottom py-3 my-1">
                ...
                <div className="col-6 col-sm-4 col-xl-6 fw-bold text-center">Nombre Usuario</div>
                <div className="col-6 col-sm-4 col-xl-3 fw-bold text-center">Rol</div>
              ...
              <div className="row">
                <div className="col-12">
                  {lista.map((item, index) => (
                    <div className="fila_listado row" key={item?.id_usuario} id={item?.id_usuario}>
                      <div className="col-12 col-sm-1 fw-bold text-center">{index + 1 + (paginaActual - 1) * LISTA_MAX_REGS}</div>
                      <div className="col-12 col-xl-6 flex-grow-1">{item?.nombre_usuario}</div>
                      <div className="col-12 col-xl-3 text-center">{item?.nombre_rol}</div>
                      <div className="col-12 col-xl-2">
                        <div className="row d-flex justify-content-end justify-content-xl-center my-2 my-md-0">
                          <div className="col-4 col-sm-2 col-xl-6 text-end">
                            <Link
                              id={`btnmp-${item?.id_usuario}`}
                              to={`/main-page/master/${modelo}/${item?.id_usuario}`}
